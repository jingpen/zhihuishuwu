    ...
    <div>
       <div class="contntbox">
        <div class="left-content">
          <ul>
            <li class="booklist" v-for="(val,index) in  ranking.female" :key="index" :class="{active: index === currentIndex}" @click="selected(index)">
        ...
        <div class="right-content">
            ...
            <div class="new" v-for="(item,index) in femaleranking" :key="index" @click="setdetail(item)">
            <div class="img">
...
export default {
    ...
    methods:{
       selected(index) {
          ...
          this.$http(`/ranking/${this.ranking.female[index]._id}`).then(res=>{
               let data=res.data.ranking.books;
               this.femaleranking=data;
           })
       },
        imgurl(index){
           return unescape(this.femaleranking[index].cover).slice(7);
