    ...
    <div>
       <div class="contntbox">
        ...
        <div class="right-content">
            ...
            <div class="new" v-for="(item,index) in epubranking" :key="index" @click="setdetail(item)">
            <div class="img">
...
export default {
    ...
    methods:{
       selected(index) {
          ...
          this.$http(`/ranking/${this.ranking.epub[index]._id}`).then(res=>{
               let data=res.data.ranking.books;
               this.epubranking=data;
               
           })
       },
        imgurl(index){
           return unescape(this. epubranking[index].cover).slice(7);
