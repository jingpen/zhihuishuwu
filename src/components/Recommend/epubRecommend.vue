<template>
  <div>
    <div class="title">网上推荐</div>
    <div class="pressnew" v-for="(item,index) in epubdata" :key="index"  @click="setdetail(item)">
      <div class="new">
        <div class="img">
...
export default {
    ...
    methods:{
       imgurl(index) {
      return unescape(this.epubdata[index].cover).slice(7);
    },
    setdetail(item){
