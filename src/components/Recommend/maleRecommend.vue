<template>
  <div>
    <div class="title">男生推荐</div>
    <div class="pressnew" v-for="(item,index) in maledata" :key="index" @click="setdetail(item)">
      <div class="new">
        <div class="img">
...
export default {
    ...
    methods:{
       imgurl(index) {
      return unescape(this.maledata[index].cover).slice(7);
    },
     setdetail(item){
